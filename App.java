...
public class App {
    public static void main(String[] args) throws Exception{
        ...
        if (len < 8 || len > 16){
            System.out.println("Please try again and enter a password between 8 and 16 letters.");
            System.exit(1);
        }
        ...
        if(count.size() < 3){
            System.out.println("Please enter a valid password with at least three different combinations of characters.");
            System.exit(0);
        }
